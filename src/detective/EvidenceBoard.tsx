...
export function EvidenceBoard({
  ...
  const visibleNodeIds = boardData.nodes
    .map((n) => n.id)
  ...
  const handleContextMenu = useCallback(
    (evidenceId: string, e: React.MouseEvent) => {
      e.preventDefault()
  ...
  const boardClass = [styles.board, activeTool ? styles.toolMode : '']
    .filter(Boolean)
    .join(' ')
