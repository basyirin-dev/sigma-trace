...
export function Toolbelt({ activeTool, usedTools, onSelectTool, onRequestTutorialHelp }: ToolbeltProps) {
  return (
      ...
      {TOOLS.map((tool) => {
        ...
        const button = (
          ...
          >
            ...
            {isUsed && <span className={styles.usedBadge} data-testid="used-badge">✓</span>}
          </button>
        )
